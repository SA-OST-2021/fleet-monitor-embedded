...
#else
#define SS_PIN_DEFAULT  10
#define CLK_PIN_DEFAULT 36 
#define MISO_PIN_DEFAULT 37
#define MOSI_PIN_DEFAULT 35
#endif
...
uint8_t  W5100Class::clk_pin = CLK_PIN_DEFAULT;
uint8_t  W5100Class::miso_pin = MISO_PIN_DEFAULT;
uint8_t  W5100Class::mosi_pin = MOSI_PIN_DEFAULT;
