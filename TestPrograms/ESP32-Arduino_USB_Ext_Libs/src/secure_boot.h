...
// struct ets_secure_boot_signature_t;        // Florian Baumgartner: Removed this line because of error: conflicting
// declaration
...
*/
ets_secure_boot_status_t ets_secure_boot_verify_bootloader_with_keys(uint8_t *verified_hash,
